...
export const SplineScene1 = () => (
  <SectionSplineScene 
    scene="https://prod.spline.design/MHqJwmvmbjGpqqsK/scene.splinecode"
    className="relative min-h-[500px] rounded-t-3xl"
  />
);
...
export const SplineScene2 = () => (
  <div className="rounded-t-3xl overflow-hidden my-24 relative">
    <SectionSplineScene 
      ...
      className="relative min-h-[600px] rounded-t-3xl"
    />
  </div>
);
...
export const SplineScene3 = () => (
  <SectionSplineScene 
    scene="https://prod.spline.design/0nym7UV9LJSa8kuC/scene.splinecode"
    className="relative min-h-[500px] rounded-t-3xl"
  />
);
...
export const SplineScene5 = () => (
  <SectionSplineScene 
    scene="https://prod.spline.design/sETXtt2xBru24o3T/scene.splinecode"
    className="relative min-h-[500px] rounded-t-3xl"
  />
);
...
export const SplineScene6 = () => (
  <div className="py-32 relative">
    <SectionSplineScene 
      ...
      className="relative min-h-[700px] rounded-t-3xl"
    />
